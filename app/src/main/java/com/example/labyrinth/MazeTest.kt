...
var poleWynik: Pole = Pole('S', x=1, y= 1)
var tablica2: Array<Array<Pole>> = Array(8){Array<Pole>(8){Pole('u')} }
var nodeQueue: MutableList<Pole> = mutableListOf(Pole('W'))
var lastNode: Pole = Pole('s')
            ...
            if (present.sign == '*'){
                ...
                when {
                    west.sign == '0' && north.sign == '0' && east.sign == '0' && south.sign == '0' -> {
                        ...
                        polePoczatkowe.visited = false
                        polePoczatkowe.hasChild++
                        nodeQueue.add(polePoczatkowe)
